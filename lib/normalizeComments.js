/**
  Pulled directly from `pulsar-edit/pulsar/spec/helpers/normalize-comments.js`:
  https://github.com/pulsar-edit/pulsar/blob/v1.131.3/spec/helpers/normalize-comments.js

  This file is used both in the `jasmine1-test-runner` and the `jasmine2-test-runner`.
*/
