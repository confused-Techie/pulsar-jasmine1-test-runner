// Test the fundementals of Jasmine v1.3.1
// https://jasmine.github.io/archives/1.3/introduction
// https://github.com/UziTech/atom-jasmine3-test-runner/blob/master/spec/jasmine/jasmine-spec-v1.js
...
describe("Included matchers:", () => {
  ...
  describe("The 'toEqual' matcher", () => {
    it("works for simple literals and varaibles", () => {
      let a = 12;
      expect(a).toEqual(12);
    });
